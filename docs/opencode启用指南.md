...
> 技能库版本：v21.12.0 ｜ 最后更新：2026-09-01
...
运行时 opencode 扫描该目录下的 `SKILL.md`，将 10 个角色包 + 1 个编排器注册为可加载技能。
...
| 8 | role-program-mgmt | 项目群/项目集（定义/收益/依赖/IMS/标准一致/评审/收尾） |
| 9 | role-mgmt-consulting | 项目管理咨询（机会/诊断/方案/变革/成效/成熟度） |
| 10 | role-project-mgmt | 项目经理执行层（日常管控/RAID/进展报告/变更协调/经验教训） |
