...
description: "用户提到架构策略/架构设计/架构评估/技术选型/4+1视图/C4模型/数据架构/安全架构/ADR/架构评审/ATAM时加载本架构设计角色包：负责架构策略分析、4+1视图与C4逻辑设计、数据与安全架构设计、ADR决策、ATAM评审及基线固化，输出架构设计说明书、ADR与评审报告。用户说架构策略/设计/评审时加载。"
---
