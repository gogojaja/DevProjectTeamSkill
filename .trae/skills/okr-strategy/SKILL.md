---
name: "okr-strategy"
description: "用户提到OKR/目标与关键结果/KPI/战略对齐/战略主题/对齐度检查/孤儿项目/季度目标/绩效指标/目标管理/关键结果/战略落地/绩效评估/目标追踪时加载本 OKR 战略对齐技能：负责 OKR 层级管理（组织级 Objective→项目群 Key Result→项目 KPI）、OKR 进度更新与季度评分（0~1.0，0.6~0.7 理想区间）、项目-战略主题映射与对齐度评分、对齐度审计（孤儿项目检测）。可脱离编排器独立部署运行。不加载：项目组合管理（→portfolio-mgmt）、项目群管理（→role-program-mgmt）。"
---
