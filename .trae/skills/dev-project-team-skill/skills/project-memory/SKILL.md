---
name: "project-memory"
description: "用户提到项目记忆、持久化记忆、长期记忆、决策记录、知识图谱、知识库、经验沉淀、上下文恢复时加载本持久化记忆层技能：跨会话/跨模型的项目级长期记忆，支持决策记录、架构约束、知识图谱、跨项目知识库、上下文恢复，内置 Notepad/ProjectMemory/向量检索引擎，保证跨会话上下文连贯。用户说记忆/决策记录/上下文恢复时加载。"
---
...
| `domain/knowledge-base.md` | 知识库能力（dev-knowledge-base 技能化）：知识资产分类/沉淀流程(22复盘+23复用资产+经验库)/检索/复用规则，跨项目组织级知识资产管理 |
...
**文档版本**：v1.2.0　**最后更新**：2026-09-01（新增 `domain/knowledge-base.md` 知识库能力，dev-knowledge-base 项目技能化，项目群规划 v3.0 评分 71/100；此前：v1.1.0 繁体转简体 + 新增闭环执行系统章节）
